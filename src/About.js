...
class Item extends Component {
  ...
  render() {
    const { styles, productoss } = this;
    const product = productoss.find(p => p.id == this.props.match.params.id) || {
      ...productoss[Math.floor(Math.random() * productoss.length)]
    };
    return (
      <Fragment>
        ...
        <div style={styles.itemContainer}>
          ...
          <div style={styles.detailsContainer}>
            ...
            <p style={styles.shipping}>Información de Envio</p>
